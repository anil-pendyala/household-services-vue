...
const MyBookings = {
           ...
           <div v-for="request in completedRequests" :key="request.id" class="card mb-3 shadow-sm">
             <div class="card-body">
               <div class="row">
                 ...
                 <div class="col-md-4 d-flex flex-column justify-content-center align-items-end">
                   <button v-if="!request.has_review" @click="openReviewModal(request)" class="btn btn-outline-primary w-100">
                     Add Review
                   </button>
     ...
     methods: {
       ...
       formatStatus(status) {
         ...
         // Match with the ServiceStatus enum in the model
         const statusMap = {
           'REQUESTED': 'Requested',
           'ASSIGNED': 'Assigned',
           'CLOSED': 'Completed',
